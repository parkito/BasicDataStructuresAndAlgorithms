package ru.siksmfp.basic.structure.doubleLinkedList;
...
/**
 * Typical com.saiu.ru.siksmfp.basic.structure.doubleLinkedList
 *
 * @param <T> object type for storing in com.saiu.ru.siksmfp.basic.structure.doubleLinkedList
 */
public class DoubleLinkedList<T> {
    ...
    /**
     * Adding element to com.saiu.ru.siksmfp.basic.structure.doubleLinkedList
     *
    ...
    /**
     * Displaying com.saiu.ru.siksmfp.basic.structure.doubleLinkedList from index = 0
     */
    ...
    /**
     * Displaying com.saiu.ru.siksmfp.basic.structure.doubleLinkedList from last index
     */
     ...
     */
     ...
     /*
        * There are 3 situations when is needed to remove list from com.saiu.ru.siksmfp.basic.structure.doubleLinkedList
