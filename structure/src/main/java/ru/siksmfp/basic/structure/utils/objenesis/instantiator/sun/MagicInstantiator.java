...
import ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils;

import java.io.ByteArrayOutputStream;
import java.io.DataOutputStream;
import java.io.IOException;

import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.ACC_FINAL;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.ACC_PUBLIC;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.ACC_SUPER;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.CONSTANT_Class;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.CONSTANT_Methodref;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.CONSTANT_NameAndType;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.CONSTANT_Utf8;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.OPS_aload_0;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.OPS_areturn;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.OPS_dup;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.OPS_invokespecial;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.OPS_new;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.OPS_return;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.classNameToInternalClassName;
import static ru.siksmfp.basic.structure.utils.objenesis.instantiator.util.ClassDefinitionUtils.getExistingClass;
