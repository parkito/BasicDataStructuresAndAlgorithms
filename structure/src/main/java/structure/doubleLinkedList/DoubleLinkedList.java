...
/**
 * Typical com.saiu.structure.doubleLinkedList
 *
 * @param <T> object type for storing in com.saiu.structure.doubleLinkedList
 */
public class DoubleLinkedList<T> {
    ...
    /**
     * Adding element to com.saiu.structure.doubleLinkedList
     *
    ...
    /**
     * Displaying com.saiu.structure.doubleLinkedList from index = 0
     */
    ...
    /**
     * Displaying com.saiu.structure.doubleLinkedList from last index
     */
     ...
     */
     ...
     /*
        * There are 3 situations when is needed to remove list from com.saiu.structure.doubleLinkedList
