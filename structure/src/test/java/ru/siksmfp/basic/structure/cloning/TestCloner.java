...
import ru.siksmfp.basic.structure.cloning.domain.A;
import ru.siksmfp.basic.structure.cloning.domain.B;
import ru.siksmfp.basic.structure.cloning.domain.F;
import ru.siksmfp.basic.structure.cloning.domain.G;
import ru.siksmfp.basic.structure.utils.cloning.Cloner;
import ru.siksmfp.basic.structure.utils.cloning.FastClonerHashMap;
import ru.siksmfp.basic.structure.utils.cloning.Immutable;
...
public class TestCloner extends TestCase {
    ...
    public void testDontCloneSynthetic() {
        ...
        final SynthOuter.Inner inner = outer.getInner();
        final SynthOuter.Inner clonedInner = cloner.deepClone(inner);
