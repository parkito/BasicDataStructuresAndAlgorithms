...
public class BinaryProbHashTableTest {
    ...
    public void firstTest() {
        HashTable<Integer, Integer> hashTable = new BinaryProbHashTable<>(10);
        hashTable.add(1, 1);
        hashTable.add(2, 2);
        hashTable.add(3, 3);
        hashTable.add(4, 4);
    ...
    public void ninthTest() {
        ...
        HashTable<Integer, Integer> hashTable = new BinaryProbHashTable<>(bigSize);
    ...
    public void eleventhTest() {
        HashTable<Integer, Integer> hashTable1 = new BinaryProbHashTable<>(10);
        hashTable1.add(1, 1);
        hashTable1.add(2, 2);

        HashTable<Integer, Integer> hashTable2 = new BinaryProbHashTable<>(10);
        hashTable2.add(1, 1);
        hashTable2.add(2, 2);
