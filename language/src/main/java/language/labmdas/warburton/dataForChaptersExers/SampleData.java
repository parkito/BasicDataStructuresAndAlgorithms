package language.labmdas.warburton.dataForChaptersExers;
...
public class SampleData {
    ...
    public static Stream<Album> albums = Arrays.asList(aLoveSupreme, sampleShortAlbum, manyTrackAlbum).stream();
